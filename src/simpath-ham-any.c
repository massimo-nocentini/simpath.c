...
#line 55 "simpath.w"
    ...
    {
        if (strcmp(argv[2], v->name) == 0)
            source = v;
        if (strcmp(argv[3], v->name) == 0)
            target = v;
